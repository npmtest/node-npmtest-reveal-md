...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-reveal-md/node_modules/reveal-md/bin/cli.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-reveal-md/node_modules/reveal-md/bin/cli.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-reveal-md/node_modules/reveal-md/bin/</a> &#187; cli.js</div>
</div>
<div class="body">
...
program
  ...
  .parse(process.argv);
&nbsp;
<span class="missing-if-branch" title="if path not taken" >I</span>if(program.args.length &gt; 2) {
